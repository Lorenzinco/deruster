...
def train():
    ...
    model = DerusterModel(device="mps", dropout=0.1, num_layers=3, nhead=32, dim_model=32)
    train_performance, validation_performance = model.train(deruster_train, deruster_validation, epochs=100, lr=1e-4, batch_size=8)
